...
extern "C" fn mods_mounted(_ev: arcropolis_api::Event) {
    ...
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("jump_y"), 0, 47.848));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("dash_speed"), 0, 1.58));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("walk_accel_mul"), 0, 0.097));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("walk_accel_add"), 0, 0.243));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("walk_speed_max"), 0, 0.84));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("ground_brake"), 0, 0.062));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("run_accel_mul"), 0, 0.12));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("run_accel_add"), 0, 0.026));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("run_speed_max"), 0, 1.67));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("jump_speed_x"), 0, 0.87));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("jump_speed_x_mul"), 0, 0.768));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("jump_speed_x_max"), 0, 2.672));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("jump_aerial_speed_x_mul"), 0, 1.089));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("air_accel_y"), 0, 0.09));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("jump_aerial_y"), 0, 28.248));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("jump_initial_y"), 0, 28.548));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("mini_jump_y"), 0, 15.155));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("air_accel_x_mul"), 0, 0.085));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("air_accel_x_add"), 0, 0.02));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("dive_speed_y"), 0, 2.2));
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("weight"), 0, 93.0));
    ...
    param_config::update_float_2(*FIGHTER_KIND_DOLLY, marked_slots.clone(), (smash::hash40("param_special_hi"), smash::hash40("speed_y_mul"), 0.55));
    ...
    the_csk_collection_api::add_chara_db_entry_info(
        the_csk_collection_api::CharacterDatabaseEntry {
            ...
            ui_series_id: the_csk_collection_api::Hash40Type::Overwrite(0xFFA7E1301 /* Hash40 of ui_series_mario */), 
            ...
            ext_skill_page_num: the_csk_collection_api::SignedByteType::Overwrite(2), 
