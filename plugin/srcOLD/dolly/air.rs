...
unsafe extern "C" fn dolly_fair(fighter: &mut L2CAgentBase) {
            frame(fighter.lua_state_agent, 12.0);
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, 0, 0, Hash40::new("handl"), 13.0, 361, 102, 0, 20, 5.7, 2.3, 0.0, 0.0, None, None, None, 1.0, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_PUNCH);
...
pub fn install() {
    Agent::new("dolly")
        .game_acmd("game_attackairnwaluigi", dolly_nair)
        .effect_acmd("effect_attackairnwaluigi", dolly_nair_effect)
        .expression_acmd("expression_attackairnwaluigi", dolly_nair_expression)
        .sound_acmd("sound_attackairnwaluigi", dolly_nair_sound)
        .game_acmd("game_attackairhiwaluigi", dolly_uair)
        .effect_acmd("effect_attackairhiwaluigi", dolly_uair_effect)
        .expression_acmd("expression_attackairhiwaluigi", dolly_uair_expression)
        .sound_acmd("sound_attackairhiwaluigi", dolly_uair_sound)
        .game_acmd("game_attackairlwwaluigi", dolly_dair)
        .effect_acmd("effect_attackairlwwaluigi", dolly_dair_effect)
        .sound_acmd("sound_attackairlwwaluigi", dolly_dair_sound)
        .expression_acmd("expression_attackairlwwaluigi", dolly_dair_expression)
        .game_acmd("game_attackairbwaluigi", dolly_bair)
        .effect_acmd("effect_attackairbwaluigi", dolly_bair_effect)
        .sound_acmd("sound_attackairbwaluigi", dolly_bair_sound)
        .expression_acmd("expression_attackairbwaluigi", dolly_bair_expression)
        .game_acmd("game_attackairfwaluigi", dolly_fair)
        .effect_acmd("effect_attackairfwaluigi", dolly_fair_effect)
        .sound_acmd("sound_attackairfwaluigi", dolly_fair_sound)
        .expression_acmd("expression_attackairfwaluigi", dolly_fair_expression)
        .install();
}