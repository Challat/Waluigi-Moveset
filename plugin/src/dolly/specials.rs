...
unsafe extern "C" fn dolly_frame(fighter: &mut L2CFighterCommon) {
    unsafe {
        ...
        stick_x *= PostureModule::lr(boma);
            ...
            if !(MotionModule::motion_kind(fighter.module_accessor) == hash40("down_attack_d") || MotionModule::motion_kind(fighter.module_accessor) == hash40("down_attack_u")) {
                ModelModule::set_mesh_visibility(boma,Hash40::new("hammer"),false);
                ModelModule::set_mesh_visibility(boma,Hash40::new("hammerflip"),false);
            }
...
unsafe extern "C" fn dolly_specialhi1(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        notify_event_msc_cmd!(fighter, Hash40::new_raw(0x2127e37c07), *GROUND_CLIFF_CHECK_KIND_ALWAYS_BOTH_SIDES);
        macros::ATTACK(fighter, 0, 0, Hash40::new("top"), 0.5, 90, 10, 80, 50, 5.0, 0.0, 0.0, 0.0, Some(0.0), Some(0.0), Some(0.0), 0.5, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 7, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_KICK);
        macros::ATTACK(fighter, 1, 0, Hash40::new("hip"), 0.5, 90, 10, 80, 50, 9.0, 0.0, 0.0, 0.0, Some(0.0), Some(0.0), Some(0.0), 0.5, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 7, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_KICK);
        macros::ATTACK(fighter, 2, 0, Hash40::new("bust"), 0.5, 90, 10, 80, 50, 9.0, 0.0, 0.0, 0.0, Some(0.0), Some(0.0), Some(0.0), 0.5, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 7, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_KICK);
        macros::ATTACK(fighter, 3, 0, Hash40::new("head"), 0.5, 90, 10, 80, 50, 7.0, 0.0, 0.0, 0.0, Some(0.0), Some(0.0), Some(0.0), 0.5, 1.0, *ATTACK_SETOFF_KIND_ON, *ATTACK_LR_CHECK_F, false, 0, 0.0, 7, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_S, *COLLISION_SOUND_ATTR_PUNCH, *ATTACK_REGION_KICK);
    }
    ...
    if macros::is_excute(fighter) {
        notify_event_msc_cmd!(fighter, Hash40::new_raw(0x2127e37c07), *GROUND_CLIFF_CHECK_KIND_ALWAYS_BOTH_SIDES);
        macros::ATTACK(fighter, 0, 0, Hash40::new("top"), 9.0, 83, 55, 0, 90, 5.0, 0.0, 0.0, 0.0, Some(0.0), Some(0.0), Some(0.0), 1.2, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        macros::ATTACK(fighter, 1, 0, Hash40::new("hip"), 9.0, 83, 55, 0, 90, 9.0, 0.0, 0.0, 0.0, Some(0.0), Some(0.0), Some(0.0), 1.2, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        macros::ATTACK(fighter, 2, 0, Hash40::new("bust"), 9.0, 83, 55, 0, 90, 9.0, 0.0, 0.0, 0.0, Some(0.0), Some(0.0), Some(0.0), 1.2, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
        macros::ATTACK(fighter, 3, 0, Hash40::new("head"), 9.0, 83, 55, 0, 90, 7.0, 0.0, 0.0, 0.0, Some(0.0), Some(0.0), Some(0.0), 1.2, 1.0, *ATTACK_SETOFF_KIND_OFF, *ATTACK_LR_CHECK_F, false, 0, 0.0, 0, false, false, false, false, true, *COLLISION_SITUATION_MASK_GA, *COLLISION_CATEGORY_MASK_ALL, *COLLISION_PART_MASK_ALL, false, Hash40::new("collision_attr_normal"), *ATTACK_SOUND_LEVEL_M, *COLLISION_SOUND_ATTR_KICK, *ATTACK_REGION_KICK);
    }
...
unsafe extern "C" fn dolly_specialhi1_sound(fighter: &mut L2CAgentBase) {
    frame(fighter.lua_state_agent, 1.0);
    if macros::is_excute(fighter) {
        macros::PLAY_SE(fighter, Hash40::new("vc_dolly_special_h01"));
    }
    frame(fighter.lua_state_agent, 6.0);
    if WorkModule::get_int(fighter.module_accessor, *FIGHTER_DOLLY_STATUS_SPECIAL_COMMON_WORK_INT_STRENGTH) == *FIGHTER_DOLLY_STRENGTH_W {
        frame(fighter.lua_state_agent, 8.0);
...
unsafe extern "C" fn dolly_speciallwattack2(fighter: &mut L2CAgentBase) {
    ...
    if macros::is_excute(fighter) {
        macros::ATTACK(fighter, /*ID*/ 0, /*Part*/ 0, /*Bone*/ Hash40::new("top"), /*Damage*/ 2.0, /*Angle*/ 37, /*KBG*/ 80, /*FKB*/ 60, /*BKB*/ 0, /*Size*/ 6.0, /*X*/ 0.0, /*Y*/ 12.0, /*Z*/ 10.0, /*X2*/ None, /*Y2*/ None, /*Z2*/ None, /*Hitlag*/ 2.0, /*SDI*/ 1.0, /*Clang_Rebound*/ *ATTACK_SETOFF_KIND_ON, /*FacingRestrict*/ *ATTACK_LR_CHECK_F, /*SetWeight*/ false, /*ShieldDamage*/ 0, /*Trip*/ 0.0, /*Rehit*/ 0, /*Reflectable*/ false, /*Absorbable*/ false, /*Flinchless*/ false, /*DisableHitlag*/ false, /*Direct_Hitbox*/ true, /*Ground_or_Air*/ *COLLISION_SITUATION_MASK_GA, /*Hitbits*/ *COLLISION_CATEGORY_MASK_ALL, /*CollisionPart*/ *COLLISION_PART_MASK_ALL, /*FriendlyFire*/ false, /*Effect*/ Hash40::new("collision_attr_normal"), /*SFXLevel*/ *ATTACK_SOUND_LEVEL_L, /*SFXType*/ *COLLISION_SOUND_ATTR_FIRE, /*Type*/ *ATTACK_REGION_BODY);
    }
...
pub fn install() {
    ...
    .game_acmd("game_specialsbstartwaluigi", dolly_specialsbstart, Default)
    .sound_acmd("sound_specialsbstartwaluigi", dolly_specialsbstart_sound, Default)
    .expression_acmd("expression_specialsbstartwaluigi", dolly_specialsbstart_expression, Default)
    .effect_acmd("effect_specialsbstartwaluigi", dolly_specialsbstart_effect, Default)
    .game_acmd("game_specialairsfendwaluigi", dolly_specialairsfend, Default)
    .effect_acmd("effect_specialairsfendwaluigi", dolly_specialairsfend_effect, Default)
    .sound_acmd("sound_specialairsfendwaluigi", dolly_specialairsfend_sound, Default)
    .game_acmd("game_specialairsfend2", dolly_specialairsfend2, Default)
    .effect_acmd("effect_specialairsfend2", dolly_specialairsfend2_effect, Default)
    .game_acmd("game_specialsfstartwaluigi", dolly_specialsfstart, Default)
    .effect_acmd("effect_specialsfstartwaluigi", dolly_specialsfstart_effect, Default)
    .sound_acmd("sound_specialsfstartwaluigi", dolly_specialsfstart_sound, Default)
    .expression_acmd("expression_specialsfstartwaluigi", dolly_specialsfstart_expression, Default)
    .game_acmd("game_specialairsfstartwaluigi", dolly_specialairsfstart, Default)
    .effect_acmd("effect_specialairsfstartwaluigi", dolly_specialairsfstart_effect, Default)
    .sound_acmd("sound_specialairsfstartwaluigi", dolly_specialairsfstart_sound, Default)
    .game_acmd("game_specialairsfattackwaluigi", dolly_specialsfaattack, Default)
    .sound_acmd("sound_specialairsfattackwaluigi", dolly_specialsfaattack_sound, Default)
    .game_acmd("game_specialhi1waluigi", dolly_specialhi1, Default)
    .effect_acmd("effect_specialhi1waluigi", dolly_specialhi1_effect, Default)
    .sound_acmd("sound_specialhi1waluigi", dolly_specialhi1_sound, Default)
    .game_acmd("game_specialairhi1waluigi", dolly_specialairhi1, Default)
    .effect_acmd("effect_specialairhi1waluigi", dolly_specialairhi1_effect, Default)
    .sound_acmd("sound_specialairhi1waluigi", dolly_specialairhi1_sound, Default)
    .effect_acmd("effect_speciallwstartwaluigi", dolly_speciallwstart_effect, Default)
    .effect_acmd("effect_specialairlwstartwaluigi", dolly_specialairlwstart_effect, Default)
    .sound_acmd("sound_speciallwstartwaluigi", dolly_speciallwstart_sound, Default)
    .sound_acmd("sound_specialairlwstartwaluigi", dolly_specialairlwstart_sound, Default)
    .effect_acmd("effect_speciallwshield", dolly_speciallwshield_effect, Default)
    .sound_acmd("sound_speciallwshield", dolly_speciallwshield_sound, Default)
    .game_acmd("game_speciallwattack1", dolly_speciallwattack1, Default)
    .effect_acmd("effect_speciallwattack1", dolly_speciallwattack1_effect, Default)
    .sound_acmd("sound_speciallwattack1", dolly_speciallwattack1_sound, Default)
    .game_acmd("game_speciallwattack2", dolly_speciallwattack2, Default)
    .effect_acmd("effect_speciallwattack2", dolly_speciallwattack2_effect, Default)
    .sound_acmd("sound_speciallwattack2", dolly_speciallwattack2_sound, Default)
    .game_acmd("game_speciallwattack3", dolly_speciallwattack3, Default)
    .effect_acmd("effect_speciallwattack3", dolly_speciallwattack3_effect, Default)
    .sound_acmd("sound_speciallwattack3", dolly_speciallwattack3_sound, Default)
    .game_acmd("game_speciallwattackspecial1", dolly_speciallwattackspecial1, Default)
    .effect_acmd("effect_speciallwattackspecial1", dolly_speciallwattackspecial1_effect, Default)
    .sound_acmd("sound_speciallwattackspecial1", dolly_speciallwattackspecial1_sound, Default)
    .game_acmd("game_speciallwattackspecial2", dolly_speciallwattackspecial2, Default)
    .effect_acmd("effect_speciallwattackspecial2", dolly_speciallwattackspecial2_effect, Default)
    .sound_acmd("sound_speciallwattackspecial2", dolly_speciallwattackspecial2_sound, Default)
    .game_acmd("game_speciallwjump", dolly_speciallwjump, Default)
    .effect_acmd("effect_speciallwjump", dolly_speciallwjump_effect, Default)
    .sound_acmd("sound_speciallwjump", dolly_speciallwjump_sound, Default)
    .game_acmd("game_speciallwspecial", dolly_speciallwspecial, Default)
    .effect_acmd("effect_speciallwspecial", dolly_speciallwspecial_effect, Default)
    .sound_acmd("sound_speciallwspecial", dolly_speciallwspecial_sound, Default)
    .game_acmd("game_speciallwattackair", dolly_speciallwattackair, Default)
    .effect_acmd("effect_speciallwattackair", dolly_speciallwattackair_effect, Default)
    .sound_acmd("sound_speciallwattackair", dolly_speciallwattackair_sound, Default)
    .game_acmd("game_speciallwspecialair", dolly_speciallwspecialair, Default)
    .effect_acmd("effect_speciallwspecialair", dolly_speciallwspecialair_effect, Default)
    .sound_acmd("sound_speciallwspecialair", dolly_speciallwspecialair_sound, Default)
    .game_acmd("game_speciallwjumpair", dolly_speciallwjumpair, Default)
    .effect_acmd("effect_speciallwjumpair", dolly_speciallwjumpair_effect, Default)
    .sound_acmd("sound_speciallwjumpair", dolly_speciallwjumpair_sound, Default)
